...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  try {
    ...
    const formattedResponse = `┌──「 *XYLO CHAT* 」──┐\n\n${aiResponse}\n\n└───────────────┘`
...
handler.desc = 'Chat XYLO with conversation memory. Use resetai to clear your chat history.'
